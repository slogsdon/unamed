            ...
            <div class="title-and-secondary">
                <div class="span10">
                    ...
                    <div class="btn-group pull-right post-actions">
                        ...
                        <a class="btn cancel" href="<?php adminUrl();?>posts">Cancel</a>
                        <a class="btn trash btn-danger" href="<?php adminUrl();?>trash/<?php echo $post->ID;?>">Trash</a>
                        <a class="btn update btn-primary">Update</a>
                    </div>
                </div>
                <div class="span6 form-horizontal">
                    ...
                    <div class="meta-info" style="display:none;">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio inline">
                                    <input type="radio" name="post_status" value="publish" class="no-border" <?php echo ($post->post_status == 'publish' ? 'checked ' : '');?>/> 
                                    published
                                </label>
                                <label class="radio inline">
                                    <input type="radio" name="post_status" value="draft" class="no-border" <?php echo ($post->post_status != 'publish' ? 'checked ' : '');?>/> 
                                    not published
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio inline">
                                    <input type="radio" name="comment_status" value="open" class="no-border" <?php echo ($post->comment_status == 'open' ? 'checked ' : '');?>/>
                                    open
                                </label>
                                <label class="radio inline">
                                    <input type="radio" name="comment_status" value="closed" class="no-border" <?php echo ($post->comment_status == 'closed' ? 'checked ' : '');?>/>
                                    closed
                                </label>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <label class="radio inline">
                                    <input type="radio" name="ping_status" value="open" class="no-border" <?php echo ($post->ping_status == 'open' ? 'checked ' : '');?>/>
                                    open
                                </label>
                                <label class="radio inline">
                                    <input type="radio" name="ping_status" value="closed" class="no-border" <?php echo ($post->post_status == 'closed' ? 'checked ' : '');?>/>
                                    closed
                                </label>
                            </div>
                        </div>
